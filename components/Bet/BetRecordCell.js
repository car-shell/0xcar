...
const BetRecord = () => {
    ...
    return (
        <>
            { !isConnected?<div style={{alignItems: 'center', textAlign:"center", position: 'relative', top: '50%'}}>The betting records will be displayed here after the wallet is connected.</div>:<StickyHeadTable  columns={columns} data={betLogs} maxHeight=''/> }
        </>
    )
}

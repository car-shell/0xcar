    ...
    <React.Fragment>
        ...
        <Stack direction='column' justifyContent="space-between" alignItems="center" width='60%' maxWidth="600px" marginBottom="32px">
            <Typography component='div' sx={{fontSize: '30px', fontStyle: 'italic', fontWeight: '700', marginTop: '48px'}}>
                JOIN <span style={{color: '#ea3423'}}>0x</span>Cardinal IDO
            </Typography>
            ...
            <Stack direction='column' justifyContent="space-between" alignItems="center" gap='4px' width='100%' sx={{border: "1px solid #7f7f7f", borderRadius: '10px', marginTop:'16px', paddingBottom: '16px'}}>
                ...
                <FormGroup width='100%' sx={{'&.MuiFormGroup-root':{backgroundColor: 'black'}}}>
                    ...
                    }} />} label={<Typography  sx={{font: '400 normal 13px arial', color: 'white'}} >I understand and agree to the <Link href='https://docs.0xcardinal.io/dto-faq' target='blank' style={{color: '#41A0DA'}}>&lt;IDO Rules&gt;</Link></Typography>}/>
                </FormGroup>
            </Stack>
        </Stack>
    </React.Fragment>);
